...
$(document).ready(function() {
    ...
    function changeBackground() {
      ...
      homeSection.css('background-position', 'left');
      homeSection.animate({ 'background-position': 'right' }, 2000, function() {
        // Reset background position to left after animation completes
        homeSection.css('background-position', 'left');
      });
    }
    ...
    // Sliding effect every 5 seconds
...
let slideInterval = setInterval(() => {
    plusSlides(1);
}, 5000); // Change slide every 5 seconds (adjust timing as needed)
